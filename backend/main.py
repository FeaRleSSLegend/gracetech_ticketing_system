...
app.add_middleware(
    CORSMiddleware,
    allow_origins=["http://localhost:5500", "http://127.0.0.1:5500", "https://grace-tech-ticketing-system-fronten.vercel.app", "https://gracetech-ticketing-system.vercel.app"],
